  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <p className="mt-6 text-slate-300">
        Vault Club brings sports, music lessons and tutoring under one roof — a
        single weekly rhythm built around discovery, progression, and instructors
        who care about confidence as much as technique.
      </p>
